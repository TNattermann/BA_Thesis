...
class TranslationEvaluation:
    ...
    def embedder(self):
        ...
        df = pd.read_csv('../data/FullTrans.csv')
        result_data = []
        ...
        embs.to_csv('data/TransEmbeddings.csv', index=False)


    def evaluate_embedding(self, persist=False):
        embs = pd.read_csv('../data/TransEmbeddings.csv')
        ...
        if persist:
            ...
            plt.savefig('Results/img/histogram_O_RT.png')
            plt.clf()
            ...
            plt.ylabel('Frequency')
            plt.savefig('Results/img/histogram_O_G.png')
